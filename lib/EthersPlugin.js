...
class EthersPlugin extends solido_2.SolidoProvider {
    ...
    prepareSigning(methodCall, options, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (hasMapAction) {
                ...
                this.instance.on(evt, () => __awaiter(this, void 0, void 0, function* () {
                    const fn = this.instance.functions[mapAction.getter];
                    const mutateRes = yield mapAction.mutation({
                        getter: fn,
    ...
    subscribe(key, fn) {
        return this._subscriber.pipe(operators_1.pluck(key)).subscribe(fn);
    }
    getAbiMethod(name) {
