...
const xdvplatform_wallet_1 = require("xdvplatform-wallet");
class EthersPlugin extends solido_2.SolidoProvider {
    ...
    onReady(settings) {
        ...
        if (walletProvider instanceof xdvplatform_wallet_1.Wallet) {
    ...
    connect() {
        if (this.walletProvider instanceof xdvplatform_wallet_1.Wallet) {
    ...
    prepareSigning(methodCall, options, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new EthersSigner_1.EthersSigner(this.provider, this.wallet, this.walletProvider, tx);
        });
    }
    subscribe(key, fn) {
